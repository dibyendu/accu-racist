...
function registerSuccessfulCompletion(id, error, time, score) {
    jQuery.ajax({
        ...
        success: function(message) {
            ...
            content += "<p style='text-align: center'>Visualize your performance by clicking <a class='fancy-plot' style='color: yellow' href='#performance-plot-holder'>here</a>" + (successLog.length <= 1 ? " (a single game won't make a nice graph)" : "") + "</p><br><div style='height: 300px; overflow-y: auto'><center><br><table border='1'><tr><th>Date</th><th>Avg. Score</th><th>Avg. Error</th><th>Avg. Time</th></tr>";
